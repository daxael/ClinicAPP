...
public class BDClinica extends SQLiteOpenHelper {
    ...
    String sqlInsertInformacionUsuario = "INSERT INTO InformacionUsuario(InformacionID, Nombre,Apellidos, Fecha, Peso,Altura, Tipo_Sangre,UsuarioID) VALUES(null, 'Rodrigo','Aibale', 01011990, 80.50, 190,'B',1)";
