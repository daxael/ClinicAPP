...
public class BDClinica extends SQLiteOpenHelper {
    ...
    String sqlCreateTableInformacionUsuario = "CREATE TABLE InformacionUsuario (InformacionID INTEGER NOT NULL PRIMARY KEY AUTOINCREMENT, Nombre VARCHAR NOT NULL, Apellidos VARCHAR NOT NULL,  Fecha DATE NOT NULL, Peso FLOAT NOT NULL, Altura FLOAT NOT NULL, Tipo_Sangre VARCHAR(4), Foto VARCHAR(200),UsuarioID INTEGER NOT NULL UNIQUE REFERENCES Usuario (UsuarioID))";
    ...
    String sqlInsertInformacionUsuario = "INSERT INTO InformacionUsuario(InformacionID, Nombre,Apellidos, Fecha, Peso, Altura, Tipo_Sangre, Foto, UsuarioID) VALUES(null, 'Rodrigo','Aibale', 01011990, 80.50, 190,'B','https://modaellos.com/wp-content/uploads/2018/10/cortes-de-pelo-para-hombre-pelo-corto.jpg',1)";
